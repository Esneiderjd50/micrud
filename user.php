                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ?>
                                ...
                                <div 
                                    class="grid grid-cols-5 items-center justify-items-center bg-neutral-900 px-5 py-2 rounded shadow shadow-neutral-900 mb-2"
                                >
                                    <p><?php echo($row['id']) ?></p>
                        ...
                        <div 
                            class="grid grid-cols-5 items-center justify-items-center bg-neutral-900 px-5 py-2 rounded shadow shadow-neutral-900"
                        >
                            <p>ID</p>
                            <p>Nombre</p>
                            <p>Correo</p>
